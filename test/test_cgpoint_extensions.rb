class TestCGPointFlip < MiniTest::Unit::TestCase
  ...
  def test_nil_if_coordinate_is_not_on_any_screen
    ...
    assert_nil CGPoint.new(max_x + max_width + 1, 0).flip!
  end

  def test_origin_in_cocoa_is_bottom_left_in_carbon
    point = CGPointZero.dup.flip!
  ...
  def test_middle_of_screen_is_still_middle_of_screen
    ...
    assert_equal point, point.dup.flip!
  end
